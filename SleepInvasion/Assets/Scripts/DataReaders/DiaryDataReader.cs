...
public class DiaryDataReader : MonoBehaviour
{
    ...
    {
        "Venus calendar:\nYear 102 Month 18 Date 02\n\nToday is a day with surprise, our people have found something very special. There was a big breakthrough In the Maya temple which weâ€™ve been graving for months,",
        "Weather: Sunny\nMood: Excited\n\nand the core of the temple has finally been reached. On the top of the central hall, there was a floating stone. Thereâ€™s so much to know about Maya civilization, so I decided to put the stone in my room to study it better.",
        "Venus calendar:\nYear 102 Month 18 Date 20\n\nToday Iâ€™ve found out the mathematics knowledge that Maya people knew. They have such fascinating way to calculate.",
        "Weather: Sunny\nMood: Peaceful\n\nHere is the rules of Maya number. Maya Math uses three symbols: dot, stick and shell. In our number, â€¢| = 6, â€¢â€¢â€¢|| = 13, â€¢|||=16. And my birthday date in Maya calendar would be â€¢â€¢â€¢|, â€¢â€¢â€¢â€¢|, â€¢, |, â€¢, â€¢",
        "Venus calendar:\nYear 102 Month 19 Date 11\n\nCuriosity has brought prosperity to our empire. Our people have been exploring the way to see the unseen, and Iâ€™m so proud that we have the technique to see whatâ€™s hidden behind the reality.",
